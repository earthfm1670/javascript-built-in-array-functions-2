...
acc: {} (เริ่มต้นว่างเปล่า)
เช็ค: acc["Chonburi"] เป็น undefined, ดังนั้นจะสร้าง property ใหม่ acc["Chonburi"] = 20000
acc ตอนนี้กลายเป็น: { Chonburi: 20000 }

รอบที่ 2:
cur: { location: "Chonburi", total: 12298 }
acc: { Chonburi: 20000 }
เช็ค: acc["Chonburi"] มีอยู่แล้ว, ดังนั้นจะบวกยอดใหม่ acc["Chonburi"] += 15000  (20000+15000)
acc ตอนนี้กลายเป็น: { Chonburi: 35000 }

รอบที่ 3:
cur: { location: "Suphanburi", total: 50000 }
acc: { Chonburi: 35000 }
เช็ค: acc["Suphanburi"] ยังไม่มีอยู่, ดังนั้นจะสร้าง property ใหม่ accumulator["Suphanburi"] = 41012
acc ตอนนี้กลายเป็น: { Chonburi: 35000, Suphanburi: 41012 }
 */
